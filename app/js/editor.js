(function() {
  ...
  amdRequire(["vs/editor/editor.main"], function() {
    let rootMainColor = getComputedStyle(document.body)
      .getPropertyValue("--main-color")
      .trim();
    emmetMonaco.emmetHTML();
    window.editorHTML = monaco.editor.create(
      document.querySelector(".editorHTML"),
      {
        language: "html",
    ...
    window.editorCSS = monaco.editor.create(
      document.querySelector(".editorCSS"),
      {
        language: "css",
        fontSize: 18,
        cursorBlinking: "solid",
    ...
    window.editorJS = monaco.editor.create(
    ...
    monaco.editor.defineTheme("purple", {
      ...
      rules: [
        {
          token: "",
          background: rootMainColor
        }
      ],
      colors: {
        "editor.background": rootMainColor,
    ...
    $(".editorJS").hide();
    $(".downpanel .lang").html(
      editorLang[window.editorHTML.getRawOptions().language]
    );
    $(".sideview .css").click(() => {
      $(".editorCSS").show();
      $(".editorJS").hide();
      $(".editorHTML").hide();
      $(".downpanel .lang").html(
        editorLang[window.editorCSS.getRawOptions().language]
      );
    });
    $(".sideview .js").click(() => {
      $(".editorCSS").hide();
      ...
      $(".editorHTML").hide();
      $(".downpanel .lang").html(
        editorLang[window.editorJS.getRawOptions().language]
      );
    });
    $(".sideview .html").click(() => {
      $(".editorCSS").hide();
